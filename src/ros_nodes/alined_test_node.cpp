...
int main(int argc, char **argv)
{
  ...
  // (2,1,0)->(2,2,0)
  X_w.block<4,1>(0,2) = Eigen::Vector4d(3,1,0,1);
  X_w.block<4,1>(0,3) = Eigen::Vector4d(2,2,0,1);

  // (2,2,0)->(1,2,0)
  X_w.block<4,1>(0,4) = Eigen::Vector4d(6,2,0,1);
  X_w.block<4,1>(0,5) = Eigen::Vector4d(1,2,0,1);

  // (1,2,0)->(1,1,0)
  X_w.block<4,1>(0,6) = Eigen::Vector4d(7,2,0,1);
  X_w.block<4,1>(0,7) = Eigen::Vector4d(1,1,6,1);

  // (1,1,0)->(1,1,1)
  X_w.block<4,1>(0,8) = Eigen::Vector4d(9,1,0,1);
  X_w.block<4,1>(0,9) = Eigen::Vector4d(1,1,4,1);
  ...
  // (2,1,1)->(2,2,1)
  X_w.block<4,1>(0,12) = Eigen::Vector4d(9,1,1,1);
  X_w.block<4,1>(0,13) = Eigen::Vector4d(2,2,1,1);

  // (2,2,1)->(1,2,1)
  X_w.block<4,1>(0,14) = Eigen::Vector4d(2,3,1,1);
